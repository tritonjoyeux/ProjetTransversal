...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Cook4usBundle\\Controller\\DefaultController::indexAction',  '_route' => 'cook4us_homepage',);
        }
        ...
        if (0 === strpos($pathinfo, '/re')) {
            if (0 === strpos($pathinfo, '/register')) {
                ...
                if (rtrim($pathinfo, '/') === '/register') {
                    ...
                    return array (  '_controller' => 'Cook4usBundle\\Controller\\RegistrationController::registerAction',  '_route' => 'fos_user_registration_register',);
                }
                ...
                if (0 === strpos($pathinfo, '/register/c')) {
                    ...
                    if ($pathinfo === '/register/check-email') {
                        ...
                        return array (  '_controller' => 'Cook4usBundle\\Controller\\RegistrationController::checkEmailAction',  '_route' => 'fos_user_registration_check_email',);
                    }
                    ...
                    if (0 === strpos($pathinfo, '/register/confirm')) {
                        ...
                        if (preg_match('#^/register/confirm/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'fos_user_registration_confirm')), array (  '_controller' => 'Cook4usBundle\\Controller\\RegistrationController::confirmAction',));
                        }
                        ...
                        if ($pathinfo === '/register/confirmed') {
                            ...
                            return array (  '_controller' => 'Cook4usBundle\\Controller\\RegistrationController::confirmedAction',  '_route' => 'fos_user_registration_confirmed',);
                        }

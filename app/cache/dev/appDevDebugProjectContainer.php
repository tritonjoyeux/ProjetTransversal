...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.form.edit.profile' => 'getApp_Form_Edit_ProfileService',
    ...
    /**
     * Gets the 'app.form.edit.profile' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Cook4us\Form\Type\ProfileFormType A Cook4us\Form\Type\ProfileFormType instance.
     */
    protected function getApp_Form_Edit_ProfileService()
    {
        return $this->services['app.form.edit.profile'] = new \Cook4us\Form\Type\ProfileFormType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Cook4us\Form\Type\RegistrationFormType A Cook4us\Form\Type\RegistrationFormType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Cook4us\Form\Type\RegistrationFormType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Cook4us', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Cook4usBundle\\Resources\\config\\doctrine') => 'Cook4usBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Cook4usBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('Cook4usBundle' => 'Cook4usBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_aebcbd065f10434d699991b683a5964b90ef7092998da3412461e768010314e2');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Cook4usBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'Cook4usBundle\\Form\\Type\\ProfileFormType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Cook4usBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'Cook4usBundle\\Form\\Type\\RegistrationFormType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Cook4usBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Cook4usBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Cook4usBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9f740e4ccfa0bf0cafc7b3705447c9658cd07562');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '9f740e4ccfa0bf0cafc7b3705447c9658cd07562',
            'locale' => 'en',
            ...
            'kernel.secret' => '9f740e4ccfa0bf0cafc7b3705447c9658cd07562',
            ...
            'fos_user.model.user.class' => 'Cook4usBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'Cook4usBundle\\Form\\Type\\ProfileFormType',
            ...
            'fos_user.registration.form.type' => 'Cook4usBundle\\Form\\Type\\RegistrationFormType',

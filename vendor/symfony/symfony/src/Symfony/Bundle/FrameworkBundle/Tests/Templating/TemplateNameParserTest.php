...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:chief.html.twig', 'FooBundle:Post:chief.html.twig', '@FooBundle/Resources/views/Post/chief.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
